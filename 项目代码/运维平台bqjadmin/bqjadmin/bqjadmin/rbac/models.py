...
class UserInfo(models.Model):
    ...
    roles = models.ManyToManyField(verbose_name='拥有的所有角色', to=Role, blank=True) #这里的to=Role一定不要加引号，因为有了abstract = True
    #这里的字段和app里用户表的字段都会出现在表里，不要重复，除非有病，这里的字段自己也可以自定义
