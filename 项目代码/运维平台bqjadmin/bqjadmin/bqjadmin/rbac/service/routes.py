...
#from django.urls import RegexURLResolver, RegexURLPattern django1.x
from django.urls import URLPattern, URLResolver #django2.x
    ...
    for item in urlpatterns:
        if isinstance(item, URLPattern):  # 非路由分发，讲路由添加到url_ordered_dict
            ...
            if pre_namespace:
                ...
                name = item.name
            #url = pre_url + item._regex  # /rbac/user/edit/(?P<pk>\d+)/ django1.0
            ...
            if pre_namespace:
                ...
                if item.namespace:
                    ...
                    namespace = None
            #recursion_urls(namespace, pre_url + item.regex.pattern, item.url_patterns, url_ordered_dict) Django1.0
